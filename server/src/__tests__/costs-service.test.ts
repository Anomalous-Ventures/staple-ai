...
import { createDb, companies, agents, costEvents, financeEvents, projects } from "@stapleai/db";
...
describeEmbeddedPostgres("cost and finance aggregate overflow handling", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("staple-costs-service-");
